...
public interface IUserProfilesRepository
{
    ...
    Task<IReadOnlyCollection<TrinderUserProfile>> GetAllFullAsync(CancellationToken cancellationToken = default);
    //TODO
    ...
    Task<bool> DeleteAsync(TrinderUserProfile userProfile, CancellationToken cancellationToken = default);
}
